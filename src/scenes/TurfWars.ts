...
export default class TurfWars extends Phaser.Scene {
    ...
    public mapWidth : number = this.tileWidth * 75;
    public mapHeight : number = this.tileWidth * 50;
    ...
    public minimapScale : number = 0.12;
    ...
    initMiniMap = () => {
        let scale = 0.12;
        this.minimap = this.add.image( 0, 0, 'stage-1' );
        this.minimapX = config.width * 0.75 - this.minimap.width * scale;
    ...
    create = () => {
        ...
        this.music = this.sound.add( 'turf-wars-music' );
